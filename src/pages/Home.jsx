  ...
  return (
    <div>
      ...
      <div className="w-2/3 mx-auto flex items-center mb-16">
          <div className="flex-grow border-t border-gray-300 dark:border-gray-700"></div>
          <span className="px-4 font-extrabold text-2xl text-red-500 bg-white dark:text-white dark-bg-gray-900 mt-4 mb-2">Top Selling Gifts</span>
          <div className="flex-grow border-t border-gray-300 dark:border-gray-700"></div>
        </div>
      <TopSellingGifts />
      ...
      <div className="w-2/3 mx-auto flex items-center mb-16">
          <div className="flex-grow border-t border-gray-300 dark:border-gray-700"></div>
          <span className="px-4 font-extrabold text-2xl text-red-500 bg-white dark:text-white dark-bg-gray-900 mt-4 mb-2">Top Selling Packges</span>
          <div className="flex-grow border-t border-gray-300 dark:border-gray-700"></div>
        </div>
        <TopSellingPackges />
        <div className="mt-16 text-center">
      ...
      <div className="w-2/3 mx-auto flex items-center mb-16">
          <div className="flex-grow border-t border-gray-300 dark:border-gray-700"></div>
          <span className="px-4 font-extrabold text-2xl text-red-500 bg-white dark:text-white dark-bg-gray-900 mt-4 mb-2">Top Selling Cake</span>
          <div className="flex-grow border-t border-gray-300 dark:border-gray-700"></div>
        </div>
        <TopSellingCakes />
        <div className="mt-16 text-center">
      ...
      <div className="w-2/3 mx-auto flex items-center mb-16">
          <div className="flex-grow border-t border-gray-300 dark:border-gray-700"></div>
          <span className="px-4 font-extrabold text-2xl text-red-500 bg-white dark:text-white dark-bg-gray-900 mt-4 mb-2">Top Selling Cards</span>
          <div className="flex-grow border-t border-gray-300 dark:border-gray-700"></div>
        </div>
