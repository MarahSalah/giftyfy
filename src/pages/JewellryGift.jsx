...
const JewellryCategory = () => {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
      {/* عنوان الصفحة */}
      <h1 style={{ marginTop: '2rem', color: '#1b2543', fontSize: '3rem', }}>Jewellry Gift Inspiration</h1>
...
export default JewellryCategory;
