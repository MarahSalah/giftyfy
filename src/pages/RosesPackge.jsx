...
const RosesPackge = () => {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
      {/* عنوان الصفحة */}
      <h1 style={{ marginTop: '2rem', color: '#1b2543', fontSize: '3rem', }}>Roses Gift Inspiration</h1>
            ...
            <div key={item.id} style={{ maxWidth: '18rem', marginBottom: '2rem' }}>
              <Link to={`/product/${item.id}`}>
                <img
                  ...
                  src="https://www.google.com/url?sa=i&url=https%3A%2F%2Frosebox.co.uk%2Fvelvetrose%2Froses-chocolate-gift-box&psig=AOvVaw0Jlq01RMO436hT8VBHgn8I&ust=1699842603187000&source=images&cd=vfe&opi=89978449&ved=0CBEQjRxqFwoTCPDK2KC1vYIDFQAAAAAdAAAAABAE"
                  alt={item.title}
                />
              </Link>
